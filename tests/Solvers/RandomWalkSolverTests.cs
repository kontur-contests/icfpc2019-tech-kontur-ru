...
namespace tests.Solvers
{
    ...
    internal class RandomWalkSolverTests : SolverTestsBase
    {
        ...
        public void SolveOne()
        {
            ...
            var solver = new RandomWalkSolver(2, new Estimator(false), new Random(seed), 100, usePalka: true, false);
        ...
        public void SolvePuzzleOneWithWheels()
        {
            ...
            var solver1 = new ParallelDeepWalkSolver(2, new Estimator(true), usePalka: true, useWheels: false, new BoosterType[0]);
            var solver = new RandomWalkSolver(2, new Estimator(true), new Random(seed), 100, usePalka: true, useWheels: true);
        ...
        public void SolvePuzzleOneWithWheelsRandom()
        {
            ...
            Console.Out.WriteLine($"Seed: {seed}");
            var solver0 = new StupidSolver(true);
            var solver1 = new ParallelDeepWalkSolver(2, new Estimator(false), usePalka: false, useWheels: false, new BoosterType[0]);
            var solver = new RandomWalkSolver(2, new Estimator(true), new Random(seed), 100, usePalka: true, useWheels: true);
        ...
        public void SolveOneZakoulochki()
        {
            ...
            var seed = -1635707027;
            Console.Out.WriteLine($"Seed: {seed}");
            var solver = new RandomWalkSolver(2, new Estimator(false, true), new Random(seed), 100, usePalka: true, false);
            SolveOneProblem(solver, 22);
            // Pr 5: 2.2 s -> 252
        }
    }
